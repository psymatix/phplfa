...
class JacobianMatrix
{
    ...
    public function delPdelD($Bi, $Bj)
    {
        //J1
    ...
    public function delPdelV($Bi, $Bj)
    {
        //J2
     ...
     public function delQdelD($Bi, $Bj)
     {
         //J3
    ...
    public function delQdelV($Bi, $Bj)
    {
        //J4
    ...
    public function formMatrix($network)
    {
        ...
        for ($i = 2; $i <= $n; ++$i) {
            for ($j = 2; $j <= $n; ++$j) {
                if (in_array($j, $this->network->voltageControlledBuses)) {
                    continue;
                }//looking out for V
        ...
        //$J3 (n-1-m) x (n-1)
         ...
         $J3 = array();
        for ($i = 2; $i <= $n; ++$i) {
            if (in_array($i, $this->network->voltageControlledBuses)) {
                continue;
            }//looking out for Q
